...
library(plotly)
plot_ly(mtcars, x = ~wt, y = ~mpg, type="scatter", height=380, width=776)
```
...
plot_ly(mtcars, x = ~wt, y = ~mpg, mode = "markers", size = ~hp,
        color = ~factor(cyl), height = 350, width = 776)
```
...
plot_ly(z = ~state_pop$Pop, text = ~state_pop$hover, locations = ~state_pop$State,
        ...
        colors = 'Blues', marker = list(line = borders), width =776, height=480) %>%
  layout(title = 'US Population in 1975', geo = map_options)
